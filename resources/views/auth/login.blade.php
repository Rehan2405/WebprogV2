                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="">
                            ...
                            <a href="{{ route('login.facebook')}}" class="btn btn-dark btn-block">Login with Github</a>
                            <a href="{{ route('login.github')}}" class="btn btn-primary btn-block">Login with Facebook</a>
                            </div>
                        </div>
